# -*- coding: utf-8 -*-
"""
UAS Penganggaran Perusahaan - Universitas Muhammadiyah Metro
Ardiansyah Japlani, S.E., M.B.A. - FEB UM Metro.

Aplikasi fokus tunggal: Ujian Akhir Semester Penganggaran Perusahaan dengan pengaman anti-contek,
...
st.set_page_config(page_title="UAS Penganggaran Perusahaan - UM Metro",
...
def buat_kartu_hasil(nama, npm, nilai, benar, total, waktu_str):
    ...
    d.text((24, 20), "BUKTI PENGERJAAN UAS PENGANGGARAN PERUSAHAAN", font=font(20, True), fill="white")
...
# ============================================================
def halaman_uas():
    st.header("🎓 Ujian Akhir Semester (UAS) Penganggaran Perusahaan")
    _mesin_ujian(
        judul="UAS",
        jenis="uas",
